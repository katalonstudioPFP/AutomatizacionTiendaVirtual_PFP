...
WebUI.callTestCase(findTestCase('ScriptsComunes/ScriptsComunes/BusquedaDeProductosEnDescuento'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('ScriptsComunes/ScriptsComunes/ComprobacionPaginaDeProductosConDescuento'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('ScriptsComunes/ScriptsComunes/ComprobarCarritoVariosProductos'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('ScriptsComunes/ScriptsComunes/ComprobacionPaginaCheckout'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('ScriptsComunes/ScriptsComunes/ComprobacionDatosDeEnvioDeCliente'), [('Nombre') : 'sonia', ('Apellido') : 'sanchez'
