...
println(GlobalVariable.BENCH_REPORT_ID)

println(GlobalVariable.API_KEY)


String comando="chmod +x download-report.sh && ./download-report.sh  " + GlobalVariable.BENCH_REPORT_ID +" "+GlobalVariable.API_KEY
//Ejecutamos el siguiente comando en consola,NECESITAMOS DESCARGAR ESE ARCHIVO DE API DE OCTOPERF
ConsoleCommandBuilder.create(comando)
