...
WebUI.waitForElementClickable(findTestObject('Modificación de datos de la cuenta con cliente registrado/Page_Mi Cuenta -/BotonAcceder'), 
    10)

WebUI.enhancedClick(findTestObject('Object Repository/Modificación de datos de la cuenta con cliente registrado/Page_Mi Cuenta -/BotonAcceder'))
